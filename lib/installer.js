...
function installProtobuf(version) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield io.cp(path.join(toolPath, 'bin'), path.join(dest, 'bin'), { recursive: true });
        yield io.cp(path.join(toolPath, 'include'), path.join(dest, 'include'), { recursive: true });
        yield exec.exec('protoc', ['--version']);
    });
}
...
function download(version) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const cachePath = yield tc.cacheDir(extractedPath, "protoc", version);
